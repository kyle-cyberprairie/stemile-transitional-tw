        ...
        <div class="container w-full max-w-c flex-col lg:flex-row items-center justify-center gap-12 py-12">
            ...
            <div class="flex flex-col md:flex-row md:gap-12 md:mb-0 mb-6">
                ...
                <div class="flex-1 mb-12">
                    ...
                    <p>The group meets every Tuesday of the month from 6-7 pm in the Parish Hall. It is mandatory to attend if you are enrolled in other sacramental classes and you don't attend a Catholic School. If you attend a Catholic school, then catechism classes are optional, yet encouraged.</p>
                    <p>Catechism is held on Tuesdays from October to May.</p>
                    <p><strong>Reconciliation:</strong></p>
                    <p>For students ages 8 and above. The group meets every 1st and 3rd Wednesday each month, from 7-8 pm in the Church (1st Semester October-January).</p>
                    ...
                    <p>Please register your children before <strong>October 2nd, 2026</strong>. You can find registration forms at the back of the church, at the parish office or you may download it below:</p>
                    <p><a href="{{ asset('documents/2026/8/Catechism Registration form 2026-2027.pdf') }}" target="_blank">Catechism Registration Form</a></p>
